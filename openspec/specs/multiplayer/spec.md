...
## Purpose
Define Defend multiplayer behavior for active co-op heroes, authoritative fixed-tick movement and combat, synchronized state, and testable browser/protocol validation.
